  ...
  return (
    <div className="page-wrapper" style={pageStyle}>
      ...
      <div className="glass-container" style={containerStyle}>
        ...
        {/* HEADER */}
        <div className="header-action" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '25px', gap: '15px', flexWrap: 'wrap' }}>
          <h2 style={titleStyle}>User Transactions</h2>
          <button onClick={() => navigate('/admin-users')} style={{ width: '36px', height: '36px', padding: '0', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: '50%', backgroundColor: '#ff4757', color: 'white', border: 'none', cursor: 'pointer', flexShrink: 0, boxShadow: '0 4px 10px rgba(255, 71, 87, 0.3)' }} title="Go Back">
